...
class AttackModel:
    ...
    def MIA_shadow_model_attack(self):
        ...
        shadow_train_res = torch.load("shadow_train_res_fashion.pt")
        shadow_test_res = torch.load("shadow_test_res_fashion.pt")
        ...
        in_eval_pre = torch.load("target_mix_train_res.pt")
        out_eval_pre = torch.load("target_mix_test_res.pt")
