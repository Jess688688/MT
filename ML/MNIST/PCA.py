...
for class_label in range(10):
    ...
    output_image = Image.fromarray(mean_image_uint8, mode='L')  # MNIST images are grayscale

    # Save the output image to the PCA folder
    output_image_path = os.path.join(output_folder, f"mnist_{class_label}_pca_composite.png")
