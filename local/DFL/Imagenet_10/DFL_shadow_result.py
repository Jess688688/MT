...
def load_partitioned_imagenet10(file_path):
...
def generate_DFL_shadow_result(num_participants, num_rounds, epochs_per_round):
    ...
    x_train, y_train, x_test, y_test = load_partitioned_imagenet10(partition_file)
...
if __name__ == "__main__":
    generate_DFL_shadow_result(num_participants = 10, num_rounds = 10, epochs_per_round = 5)
