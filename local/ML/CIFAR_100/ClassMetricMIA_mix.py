...
class ClassMetricBasedAttack:
    def __init__(self, shadow_train_res_path, shadow_test_res_path, in_eval_pre_path, out_eval_pre_path):
        ...
        # Extract number of classes for CIFAR-100
...
if __name__ == "__main__":
    # File paths for CIFAR-100
    shadow_train_res_path = "shadow_train_res_cifar100.pt"
    shadow_test_res_path = "shadow_test_res_cifar100.pt"
    in_eval_pre_path = "target_mix_train_res.pt"
    out_eval_pre_path = "target_mix_test_res.pt"

    # Initialize the attack class for CIFAR-100
